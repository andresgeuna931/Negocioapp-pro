        ...
        <>
            ...
            >
                ...
                <nav className="p-4 space-y-1">
                    ...
                    {/* Botón Soporte VIP — solo Business */}
                    {isBusiness && (
                            ...
                            onClick={onClose}
                            className="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all duration-200 bg-[#229ED9]/10 hover:bg-[#229ED9]/20 border border-[#229ED9]/30 text-[#229ED9] hover:text-white group mt-2"
                        >
                            {/* Ícono Telegram SVG */}
                            <svg
                                viewBox="0 0 24 24"
